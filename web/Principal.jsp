...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-info">           
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a style="margin-left: 10px; border: none" class="btn btn-outline-light" href="Controlador?menu=Listar&accion=Empleado" target="myFrame">Empleado</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="embed-responsives m-4" style="height: 720px;">
             <iframe class="embed-responsive-item" name="myFrame" id="myFrame" style="height: 100%; width: 100%; border:navy"></iframe>
        </div>   
